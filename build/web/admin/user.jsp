        	...
        	<table class="table">
			    ...
			    <tr>
			      ...
			      <th scope="col">PHONE</th>      
                              ...
                              <form method="post" action="manageuser">
                                  ...
                                  <th scope="col">
                                      <input value="New User" type="submit" style="color: #fff; text-align: center; border: none;
			  ...
			  <tbody>
			    <c:forEach var ="item" items="${listUser}">
				    ...
				    <td style="width: 120px">${item.password}</td>  
                                    <td style="width: 120px">${item.email}</td>
				    <td style="width: 90px">${item.phone}</td>
                                    ...
                                    <td style="width: 120px">${item.registerdate}</td>
				    <td>
                                        <form method="post" action="manageuser">
                                            ...
                                            <form style="float: left" method="post" action="manageuser">
